...
*/
namespace BeispielApp\FileSystem;
...
class CloudStorage
	...
	function storeFile($localFilePath, $contentType)
		{
		...
		$object = $this->bucket->upload($f, ['name' => $randomString, 'metadata' => ['contentType' => $contentType], 'predefinedAcl' => 'publicRead', ]);
